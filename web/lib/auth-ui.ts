...
export const labelCls =
  "block text-xs font-mono uppercase tracking-widest text-stone-500 mb-2";
...
export const messageErrorCls =
  "text-xs font-mono text-stone-500 border border-stone-200 rounded-xl px-4 py-3 bg-white/80";

export const messageSuccessCls =
  "text-xs font-mono text-stone-600 border border-stone-200 rounded-xl px-4 py-3 bg-[#ffee91]/40";
