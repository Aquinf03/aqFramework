...
import { isTrain, REQUIRED } from "./schema.js"
import { listSkills, loadSkill } from "./skill.js"
import { listTools } from "./tool.js"
import { startMcp } from "./mcp.js"
import { extraTools } from "./skill-runtime.js"
...
export async function runDoctor(cwd: string): Promise<{ checks: Check[]; ok: boolean }> {
  ...
  const kernel = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "..", "kernel", "run.py")
