...
User docs: [`docs/`](./docs/README.md). Author / architecture notes: [`docs/author/`](./docs/author/README.md).
...
Pick the train that proves what you changed. Catalog: [`docs/author/tests-catalog.md`](./docs/author/tests-catalog.md) and [`tests/README.md`](./tests/README.md).
...
**Docs:** user guides under `docs/`, examples, clarifications  
...
- Usage / how-to: [`docs/`](./docs/README.md)
- Architecture / release: [`docs/author/`](./docs/author/README.md)
